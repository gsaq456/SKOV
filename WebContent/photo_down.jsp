...
<%
	...
	//서버에 파일이 업로드된 경로를 지정
	String savePath="memberPhoto";
	//context 프로젝트의 이름
	ServletContext context=getServletContext();
	String sDownloadPath=context.getRealPath(savePath);
	//file의 실제 경로를 작성해주는 부분
	String sFilePath=sDownloadPath+"\\"+photoName;
	//윗 줄의 실제 출력될 내용을 예상
	//"SkinProject/boardUpload/첫번째 파일의 이름"
	...
	response.setHeader("Content-Disposition", "attachment; photoName="
			+photoName);
	...
	try{
		...
		in.close(); //파일 입출력에 대한 준비를 마친다.
			...
			System.out.println("Photo_down out 에러 : "+ex);
		}
