...
<div id="contact">
   <h1>게시판 글등록</h1>
   <form action="noticeboardWritePro.noticebo" method="post"
			enctype="multipart/form-data" name="boardform">
      <fieldset>
      	 
         <input type="hidden" name="NOTICE_NAME" id="NOTICE_NAME" value =<%=session.getAttribute("login_id") %> />
         <div style="height: 40px; text-align: center;">
         <label for="NOTICE_NAME" style="margin-top: 5px;">글쓴이</label><%=session.getAttribute("login_id") %>
         </div>

         <label for="NOTICE_PASS">비밀번호</label>
         <input name="NOTICE_PASS" type="password"
						id="NOTICE_PASS" required="required"/>
