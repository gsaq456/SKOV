...
<body>
	...
	<section id="listForm">
			...
			<span style="font-size: 30px; font-weight: bolder; text-align: center;">자유게시판</span>
	<%if(session.getAttribute("login_id") != null){ %>
		<h4><a href="boardWriteForm.bo">게시판글쓰기</a></h4>
	<%} %>
...
%>
   ...
   <tr>
	...
	%>
			...
			<tbody>
   <tr>
      <td width = "70"><%=articleList.get(i).getFB_NUM()%></td>
      <td width = "100"><%=articleList.get(i).getFB_HEAD()%></td>
      <td width = "500">
         <a href="boardDetail.bo?FB_num=<%=articleList.get(i).getFB_NUM()%>&page=<%=nowPage%>">
            <%=articleList.get(i).getFB_SUBJECT()%>
         </a>
      </td>

      <td width = "120"><%=articleList.get(i).getFB_NAME() %></td>
      <td width = "100"><%=articleList.get(i).getFB_DATE() %></td>
      <td width = "100"><%=articleList.get(i).getFB_READCOUNT() %></td>
   </tr>
</tbody>
			<%} %>
		</table>
...
var Pagination = {
    ...
    Click: function() {
        ...
        location.href = "boardList.bo?page="+Pagination.page;
        Pagination.Start();
    },
