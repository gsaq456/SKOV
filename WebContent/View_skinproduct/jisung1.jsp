...
JisungBean jisung = (JisungBean)request.getAttribute("jisung");
...
<body>
<h3 style = "font-weight:bold">지성제품 상세정보 페이지 입니다.</h3>
<br>

<table border="1" style=" border:20px solid pink; margin-left:430px; width:1050px; height:500px;">
<tr>
<td rowspan="6"><img width=100% height=100% src="source/images/<%=jisung.getJisung_picture()%>"></td>

<td>제품코드 : <%=jisung.getProduct_num() %></td>
</tr>
<tr>
<td>제품명 : <%=jisung.getProduct_id() %></td>
</tr>
<tr>
<td>제품타입 : <%=jisung.getProduct_type() %></td>
</tr>
<tr>
<td>주의성분 : <%=jisung.getProduct_info() %></td>
</tr>
<tr>
<td>제품 가격 : <%=jisung.getProduct_pr()%></td>
</tr>
<tr>
<td>별점 : <%=jisung.getStarpoint() %></td>
</tr>
</table>
...
<div class = "pr_starpoint" style="margin-left: 465px; width: 104px;">
   <form action="product_starpoint.pr" method = "post" name = "starform" style="margin-top: 38px; margin-bottom: 72px;">
         ...
         <input type = "hidden" name = "productCode" value = "<%=jisung.getProduct_num() %>">
         <input type = "hidden" name = "productType" value = "<%=jisung.getProduct_type() %>">
