...
TroubleBean trouble = (TroubleBean)request.getAttribute("trouble");
...
<body>
<h3 style = "font-weight:bold">트러블제품 상세정보 페이지 입니다.</h3>
   
<table border="1" style=" border:20px solid pink; margin-left:430px; width:1050px; height:500px;">
<tr>
<td rowspan="6"><img width=100% height=100% src="source/images/<%=trouble.getTrouble_picture()%>"></td>

<td>제품코드 : <%=trouble.getProduct_num() %></td>
</tr>
<tr>
<td>제품명 : <%=trouble.getProduct_id() %></td>
</tr>
<tr>
<td>제품타입 : <%=trouble.getProduct_type() %></td>
</tr>
<tr>
<td>주의성분 : <%=trouble.getProduct_info() %></td>
</tr>
<tr>
<td>제품 가격 : <%=trouble.getProduct_pr()%></td>
</tr>
<tr>
<td>별점 : <%=trouble.getStarpoint() %></td>
</tr>
</table>
<% if(session.getAttribute("login_id") != null){ %>
<div class = "pr" style="display: inline-flex;">
<div class = "pr_starpoint" style="margin-left: 451px;width: 104px;">
   <form action="product_starpoint.pr" method = "post" name = "starform"style="margin-top: 38px; margin-bottom: 72px;">
         ...
         <input type = "hidden" name = "productCode" value = "<%=trouble.getProduct_num() %>">
         <input type = "hidden" name = "productType" value = "<%=trouble.getProduct_type() %>">
         
         
      <a href="javascript:starform.submit()" class="action-button shadow animate blue"><span style="margin-left: -12px;">Star</span></a>
   </form>
</div>
<div class = "pr_coment" style="margin-left: 154px; margin-top: 38px;">
...
<% } %>
   <section id="replyArea">
         <table style="width: 1015px; margin-left: 447px;">
   <%
   if(replyList != null){
