...
BokhapBean bokhap = (BokhapBean)request.getAttribute("bokhap");
...
<body>
<h3 style = "font-weight:bold">복합성제품 상세정보 페이지 입니다.</h3>
   
<table border="1" style=" border:20px solid pink; margin-left:430px; width:1050px; height:500px;">
<tr>
<td rowspan="6"><img width=100% height=100% src="source/images/<%=bokhap.getBokhap_picture()%>"></td>

<td>제품코드 : <%=bokhap.getProduct_num() %></td>
</tr>
<tr>
<td>제품명 : <%=bokhap.getProduct_id() %></td>
</tr>
<tr>
<td>제품타입 : <%=bokhap.getProduct_type() %></td>
</tr>
<tr>
<td>주의성분 : <%=bokhap.getProduct_info() %></td>
</tr>
<tr>
<td>제품 가격 : <%=bokhap.getProduct_pr()%></td>
</tr>
<tr>
<td>별점 : <%=bokhap.getStarpoint() %></td>
</tr>
</table>
...
<div class = "pr_starpoint" style="margin-left:465px; width: 104px;">
   <form action="product_starpoint.pr" method = "post" name = "starform" style="margin-top: 38px; margin-bottom: 72px;">
         ...
         <input type = "hidden" name = "productCode" value = "<%=bokhap.getProduct_num() %>">
         <input type = "hidden" name = "productType" value = "<%=bokhap.getProduct_type() %>">
